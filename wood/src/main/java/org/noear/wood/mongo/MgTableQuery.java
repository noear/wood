...
public class MgTableQuery implements ICacheController<MgTableQuery> {
    ...
    public List<Document> selectMapList() {
        ...
        if (_cache == null) {
            ...
            String woodKey = getWoodkey(filter);
            return _cache.getEx(woodKey, () -> selectMapListDo(filter));
        }
    }
    ...
    public Document selectMap() {
        ...
        if (_cache == null) {
            ...
            String woodKey = getWoodkey(filter);
            return _cache.getEx(woodKey, () -> mongoX.findOne(table, filter));
        }
    }
    ...
    public long selectCount() {
        ...
        if (_cache == null) {
            ...
            String woodKey = getWoodkey(filter);
            return _cache.getEx(woodKey, () -> selectCountDo(filter));
        }
    }
