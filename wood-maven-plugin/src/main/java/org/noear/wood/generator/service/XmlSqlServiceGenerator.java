package org.noear.wood.generator.service;

import org.noear.wood.generator.mapper.JavaCodeBlock;
import org.noear.wood.generator.mapper.TypeBlock;
import org.noear.wood.generator.mapper.XmlSqlBlock;
import org.noear.wood.generator.mapper.XmlSqlVar;
import org.noear.wood.generator.utils.IOUtils;
...
public class XmlSqlServiceGenerator {
    ...
    public static void generate(File baseDir, File sourceDir) {
        try {
            String path = (baseDir.getAbsolutePath() + "/src/main/resources/wood");
